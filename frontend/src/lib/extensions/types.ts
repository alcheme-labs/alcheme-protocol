...
export interface ExtensionCapabilityCopy {
    section: {
        eyebrow: string;
        title: string;
        subtitle: string;
    ...
    cards: {
        retry: string;
        metaIndexedSlot(slot: number): string;
        metaWaitingIndex: string;
        disabledMessages: {
            deprecatedExtension: string;
            draftNotEnabled: string;
            registeredDisabled: string;
            default: string;
        };
        badges: Record<ExtensionAvailabilityState, string>;
        messages: {
            available: string;
            syncing: string;
            notRegistered: string;
            missingEntryHref: string;
