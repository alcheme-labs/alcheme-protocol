...
import { Compass, Flame, MapPinned, Sparkles, Users } from 'lucide-react';
        ...
        <div className={styles.page}>
            <div className="content-container">
                ...
                >
                    ...
                    <Link href="/home/map" className={styles.mapRecommendation}>
                        <div className={styles.mapRecommendationIcon}>
                            <MapPinned size={18} />
                        </div>
                        <div>
                            <h3>{t('discover.mapRecommendation.title')}</h3>
                            <p>{t('discover.mapRecommendation.description')}</p>
                        </div>
                        <span>{t('discover.mapRecommendation.action')}</span>
                    </Link>
                    <div className={styles.cardList}>
                        {circlesLoading ? (
                            <>
