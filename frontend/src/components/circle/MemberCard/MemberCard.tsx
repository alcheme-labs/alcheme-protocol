...
import type { CircleIdentityLevelValue } from '@/lib/circle/identityTypes';
...
export interface MemberProfile {
    ...
    contributionLevel?: CircleIdentityLevelValue | null;
    joinedAgo: string;
...
export default function MemberCard({
    ...
    const contributionLabel = member.contributionLevel
        ? t(`contributionLevels.${member.contributionLevel}`)
        : null;
                    ...
                    >
                        ...
                        <div className={styles.body}>
                            ...
                            <span className={`${styles.roleBadge} ${roleClass}`}>
                                {contributionLabel ? `${contributionLabel} · ${roleLabel}` : roleLabel}
                            </span>
