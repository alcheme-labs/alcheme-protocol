...
export default function KnowledgeCitationPanel({
    ...
    const handleSubmit = useCallback(async () => {
        ...
        if (!connected) {
            requestWalletConnection({ source: 'knowledge_citation' });
            return;
        }
    ...
    }, [availableSources, connected, requestWalletConnection, sdk, selectedSourceId, submitting, t, targetOnChainAddress]);
                ...
                <div className={styles.actions}>
                    {!connected && (
                        <button
                            ...
                            onClick={() => requestWalletConnection({ source: 'knowledge_citation' })}
                        >
