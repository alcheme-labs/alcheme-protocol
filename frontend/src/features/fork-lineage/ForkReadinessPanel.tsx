    ...
    return (
        <section className={styles.panel}>
            ...
            <div className={styles.rows}>
                ...
                <div className={styles.row}>
                    <span className={styles.label}>{t('labels.contextSnapshot')}</span>
                    <span className={styles.value}>{t('values.contextSnapshot')}</span>
                </div>
                <div className={styles.row}>
                    <span className={styles.label}>{t('labels.upstreamRefs')}</span>
                    <span className={styles.value}>{t('values.upstreamRefs')}</span>
                </div>
                <div className={styles.row}>
