...
export const typeDefs = gql`
  ...
  type Post {
    ...
    status: PostStatus!
    visibility: String!
    rankingAdjustmentState: String!
    rankingAdjustmentFactorBps: Int
    rankingAdjustmentExpiresAt: DateTime
  ...
  type Query {
    ...
    knowledgeRelationshipLabels(status: String = "active"): [KnowledgeRelationshipLabel!]!
  ...
  type Knowledge {
    ...
    publicationOrigin: KnowledgePublicationOrigin
    publicationOriginDigest: String
    publicationState: String!
    publicationLicenseRef: String
    publicationLicenseVersion: String
    publicationLicenseDigest: String
    publicationSourceSnapshotDigest: String
    stablePublicPath: String
    publicReleaseAuthorizedAt: DateTime
    publicationVersions(limit: Int = 20): [KnowledgePublicationVersion!]!
    relationshipAssignment: KnowledgeRelationshipAssignment!
    crystallizationOutput: CrystallizationOutputSummary
  ...
  type KnowledgePublicationVersion {
    version: Int!
    state: String!
    targetCircleId: Int!
    stablePublicPath: String!
    ...
    authorizedContributors: JSON!
    publishedAt: DateTime!
    withdrawnAt: DateTime
    createdAt: DateTime!
  }

  type KnowledgeRelationshipLabel {
    key: String!
    displayName: String!
    description: String!
    useCases: [String!]!
  ...
  type KnowledgeRelationshipAssignment {
    knowledgeId: String!
    labelKey: String!
    label: KnowledgeRelationshipLabel!
  ...
  type CrystallizationOutputSummary {
    sourceDraftPostId: Int
    sourceDraftVersion: Int
    sourceDraftVersionLabel: String
  ...
  type CrystalReceipt {
    ...
    knowledgePublicId: String!
    ownerPubkey: String!
    ownerEffectiveDisplayName: String
    ownerDisplaySource: String
    ownerCircleAlias: String
  ...
  type KnowledgePublicationOrigin {
    schemaVersion: Int!
    kind: String!
    draftPostId: Int!
    draftVersion: Int!
    ...
    targetCircleId: Int!
    committeeCircleId: Int
    submittedByPubkey: String!
    submitAuthoritySemantics: String!
  }
  ...
  enum KnowledgeContributorAssessmentKind {
    REAL
    MOCK
    HISTORICAL_FALLBACK
    UNKNOWN
  ...
  type KnowledgeContributor {
    ...
    assessmentKind: KnowledgeContributorAssessmentKind!
  ...
  type GovernanceNotificationRecovery {
    blocker: String!
    category: String
    action: String
    acceptedDecisionPreserved: Boolean!
  }
  ...
  type Notification {
    ...
    executionStatus: String
    governanceRecovery: GovernanceNotificationRecovery
    read: Boolean!
    createdAt: DateTime!
  }
  ...
  input GenerateAcceptedIssueRevisionInput {
    postId: Int!
    threadIds: [ID!]
    targetRef: String
    workingCopyHash: String
  ...
  input ApplyAcceptedIssueRevisionInput {
    postId: Int!
    generationId: Int!
    suggestionId: ID!
    workingCopyHash: String
  ...
  type IssueReviewAssistPermission {
    action: String!
    allowed: Boolean!
    reasonCode: String!
    reason: String!
  ...
  type Mutation {
    ...
    reviewDraftIssue(input: IssueReviewAssistInput!): IssueReviewAssistResult!
    generateAcceptedIssueRevision(input: GenerateAcceptedIssueRevisionInput!): GhostDraftJobResult!
    applyAcceptedIssueRevision(input: ApplyAcceptedIssueRevisionInput!): GhostDraftAcceptanceResult!

    # ── 讨论 ──
    markMessageUseful(circleId: Int!, envelopeId: String!): MessageUsefulMarkResult!
    unmarkMessageUseful(circleId: Int!, envelopeId: String!): MessageUsefulMarkResult!
