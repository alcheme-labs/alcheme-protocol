...
export async function resolveRoomDiscussionContext(
  ...
  // Boundary: circle_discussion_messages is the canonical Plaza discussion store.
  // communication_messages is not a Plaza discussion source; selected runtime
  // room content must enter knowledge flow through SourceMaterial review.
