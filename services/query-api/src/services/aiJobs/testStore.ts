...
export interface InMemoryAiJobRow {
    ...
    capabilityTraceJson: JsonValue | null;
...
function cloneRow(row: InMemoryAiJobRow | null | undefined): InMemoryAiJobRow | null {
    ...
    return {
        ...
        capabilityTraceJson: cloneJson(row.capabilityTraceJson),
    };
}
...
export function createInMemoryAiJobPrisma(seed: Partial<InMemoryAiJobRow>[] = []) {
    ...
    let crystalAssetMigrationFence: any = null;
    ...
    function insert(partial: Partial<InMemoryAiJobRow>) {
        ...
        const row: InMemoryAiJobRow = {
            ...
            taskCatalogVersion: partial.taskCatalogVersion ?? null,
            contextCapsuleId: partial.contextCapsuleId ?? null,
            capabilityTraceJson: cloneJson((partial.capabilityTraceJson as JsonValue | null | undefined) ?? null),
    ...
    return {
        crystalAssetJobMigrationFence: {
            findUnique: jest.fn(async () => crystalAssetMigrationFence ? { ...crystalAssetMigrationFence } : null),
            upsert: jest.fn(async ({ create, update }: any) => {
                crystalAssetMigrationFence = crystalAssetMigrationFence
                    ? { ...crystalAssetMigrationFence, ...update }
                    : { ...create };
                return { ...crystalAssetMigrationFence };
            }),
        },
        __setCrystalAssetMigrationFence(value: any) {
            crystalAssetMigrationFence = value ? { ...value } : null;
        },
        aiJob: {
            ...
            create: jest.fn(async ({ data }: any) => {
                ...
                const row: InMemoryAiJobRow = {
                    ...
                    taskCatalogVersion: data?.taskCatalogVersion ?? null,
                    contextCapsuleId: data?.contextCapsuleId ?? null,
                    capabilityTraceJson: cloneJson((data?.capabilityTraceJson as JsonValue | null | undefined) ?? null),
                    dedupeKey,
